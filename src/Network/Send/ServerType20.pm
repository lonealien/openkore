...
sub sendItemUse {
	...
	$msg = pack("C2", 0x89, 0x00).$targetID. pack("v1", $ID);
...
sub sendLook {
	...
	$msg = pack("C3 x1 C1", 0x9F, 0x00, $head, $body);
...
sub sendMove {
	...
	$msg = pack("C2 x1", 0xF5, 0x00) . getCoordString($x, $y, 1) . pack("x9");
...
sub sendSkillUseLoc {
	...
	$msg = pack("v1 v1 v1 v1 v1 x2", 0x0113, $y, $ID, $x, $lv);
