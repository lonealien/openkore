...
sub new {
	...
	my %packets = (
		...
		'035F' => ['sync', 'V', [qw(time)]],
		'0882' => ['actor_look_at', 'v C', [qw(head body)]],
		...
		'0936' => ['homunculus_command', 'v C', [qw(commandType, commandID)]], #f
		'0956' => ['storage_password'],
	);
	...
	$self->cryptKeys(2126071540, 1310285017, 389898249);
