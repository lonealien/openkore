...
sub new {
	...
	my %packets = (
		...
		'0944' => ['party_join_request_by_name', 'Z24', [qw(partyName)]], #f
		'092B' => ['homunculus_command', 'v C', [qw(commandType, commandID)]], #f
	...
	$self->cryptKeys(2027239849, 1491167219, 1731016559);
