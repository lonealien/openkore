...
sub new {
	...
	my %packets = (
		...
		'0876' => ['actor_info_request', 'a4', [qw(ID)]],
		'089B' => ['actor_name_request', 'a4', [qw(ID)]],
		'0944' => ['item_list_res', 'v V2 a*', [qw(len type action itemInfo)]],
	...
	$self->cryptKeys(705061579, 1319320131, 727458635);
